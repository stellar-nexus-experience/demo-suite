...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'DeFi stands for Decentralized Finance, which refers to financial services built on blockchain.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A smart contract is self-executing code that runs on a blockchain when conditions are met.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A crypto wallet stores and manages your private keys, allowing you to control your assets.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Gas fees are the transaction costs paid to validators/miners for processing blockchain transactions.',
  },
  {
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Bitcoin uses Proof of Work (PoW), where miners solve complex mathematical puzzles to validate transactions.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A DAO is a Decentralized Autonomous Organization, governed by smart contracts and community voting.',
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "HODL means 'Hold On for Dear Life', a term for holding crypto long-term despite volatility.",
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Layer 2 refers to scaling solutions built on top of the main blockchain (Layer 1) to increase speed and reduce costs.',
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Staking involves locking up cryptocurrency to help secure a blockchain network and earn rewards in return.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A dApp is a Decentralized Application that runs on a blockchain network instead of centralized servers.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Web3 refers to the vision of a decentralized internet built on blockchain technology with user ownership.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Tokenomics refers to the economic model and incentive structure of a cryptocurrency or token.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A liquidity pool is a collection of tokens locked in a smart contract to facilitate decentralized trading.',
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'APY stands for Annual Percentage Yield, showing the yearly return on staked or deposited crypto.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A private key is a secret cryptographic code that proves ownership and allows you to access your cryptocurrency.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'An oracle is a service that provides external real-world data to smart contracts on the blockchain.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Burning tokens means permanently removing them from circulation by sending them to an inaccessible address.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A flash loan is an uncollateralized DeFi loan that must be borrowed and repaid within a single transaction block.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'SCP is a Federated Byzantine Agreement consensus mechanism that enables fast, secure transactions on Stellar.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Lumens (XLM) are the native cryptocurrency of the Stellar network, used for transactions and anti-spam measures.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A seed phrase is a sequence of 12-24 words that can restore your wallet and access to your crypto assets.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Impermanent loss occurs when providing liquidity to a pool and the token prices change compared to holding them.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A testnet is a separate blockchain network used for testing and development without using real cryptocurrency.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "DYOR means 'Do Your Own Research', reminding people to research before investing in crypto projects.",
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A whale is an individual or entity that holds a very large amount of cryptocurrency, able to influence market prices.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Yield farming involves providing liquidity to DeFi protocols to earn interest, fees, or token rewards.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Cross-chain refers to the ability to transfer assets and data between different blockchain networks.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A validator is a node in a Proof of Stake network that validates transactions and creates new blocks.',
  },
];
