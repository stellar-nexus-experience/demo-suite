  ...
  const characterMessages = useMemo(
    () => ({
      home: {
        ...
        walletConnected:
          'Excellent! Your Stellar wallet is now connected. The power of Trustless Work mechanics is yours! Welcome to the ESCROW ARSENAL!',
      },
      demos: {
        welcome:
      ...
      'mini-games': {
        ...
        games: {
          'web3-basics-adventure': {
            ...
            tips: '💡 Pro Tips: Use SPACE or UP ARROW to jump. Time your jumps perfectly to avoid obstacles. The longer you survive, the higher your score! Collect power-ups to boost your abilities.',
            encouragement:
          ...
          'escrow-puzzle-master': {
            ...
            tips: '💡 Coming Soon: Solve complex puzzles involving multi-signature wallets, smart contract escrows, and trustless fund management. Master the mechanics that power decentralized work!',
            encouragement:
          ...
          'defi-trading-arena': {
            ...
            tips: '💡 Coming Soon: Compete with other traders, manage risk, optimize yields, and climb the DeFi leaderboard. Advanced strategies unlock as you progress!',
            encouragement:
          ...
          'nft-creation': {
            ...
            tips: '💡 Coming Soon: Use intuitive design tools to create NFTs, learn about IPFS storage, metadata standards, and marketplace dynamics. Your creativity meets blockchain!',
            encouragement:
    ...
    if (autoOpen && !isExpanded && !hasShownAutoWelcome) {
      setTimeout(() => {
        ...
        const welcomeMessage =
          "Welcome to the STELLAR NEXUS Experience! 🌟 I'm NEXUS PRIME, your AI Guardian.";
        setTimeout(() => {
          startTypewriter(welcomeMessage, () => {
            // Show follow-up message after welcome
            if (!walletConnected) {
              const followUpMessage =
                'To unlock the full power of the ESCROW ARSENAL and experience Trustless Work mechanics, connect your Stellar wallet!';
              startTypewriter(followUpMessage);
            } else {
              const connectedMessage =
                "Excellent! Your Stellar wallet is connected. The ESCROW ARSENAL is ready for your command! Choose your demo and let's begin the journey! ⚡";
      ...
      <div className={`fixed bottom-6 left-6 ${showDuringLoading ? 'z-[100000]' : 'z-50'}`}>
        ...
        <div ref={chatContainerRef} className='relative group animate-fadeIn'>
          ...
          <div
            ...
            style={{
              animation: showDuringLoading
                ? 'fadeIn 0.8s ease-out, float 3s ease-in-out infinite'
          ...
          >
            <div className='w-full h-full rounded-full bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center relative overflow-hidden'>
              ...
              {/* Glowing Effect */}
              <div
                className={`absolute inset-0 rounded-full ${showDuringLoading ? 'bg-gradient-to-r from-cyan-400/40 to-purple-400/40' : 'bg-gradient-to-r from-cyan-400/20 to-purple-400/20'}`}
              ></div>
              ...
              {showDuringLoading && (
                <>
                  ...
                  ></div>
                  <div
                    className='absolute -inset-2 rounded-full border-2 border-purple-400/30 animate-ping'
                    style={{ animationDuration: '2.5s', animationDelay: '0.3s' }}
                  ></div>
                  <div
                    className='absolute -inset-4 rounded-full border border-cyan-400/20 animate-ping'
              ...
              <div className='mt-3 pt-3 border-t border-white/10'>
                {!showTutorial ? (
                  <div className='space-y-2'>
                    ...
                    <p className='text-center text-white/40 text-xs'>Click outside to close</p>
                  </div>
                ) : (
                  <div className='space-y-2'>
                    {/* Tutorial Progress */}
                  ...
                  <p className='text-white/90 text-sm font-medium'>
                    {walletConnected
                      ? hasShownWelcome
                        ...
                        : 'Welcome! Click to meet NEXUS PRIME'
