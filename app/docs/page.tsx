              ...
              {activeSection === 'vibecoding' && (
                <div className='space-y-8'>
                  <div className='text-center mb-8'>
                    <h2 className='text-3xl font-bold text-white mb-4'>✨ Vibecoding Guide</h2>
                    <p className='text-lg text-white/80 max-w-3xl mx-auto'>
                      The modern approach to building with rhythm, creativity, and flow. Learn how
                      to code with vibes, not just syntax.
                    </p>
                  </div>
                    ...
                    <div className='space-y-6'>
                      ...
                      <div className='space-y-4'>
                        ...
                        <div className='bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-lg p-4 border border-cyan-400/30'>
                          ...
                          <p className='text-white/80 text-sm'>
                            Build systems that have natural rhythm - clean patterns, predictable
                            flows, and harmonious data structures.
                          </p>
                        </div>
                        <div className='bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-lg p-4 border border-green-400/30'>
                          ...
                          <p className='text-white/80 text-sm'>
                            Think outside the box, embrace unconventional solutions, and let
                            creativity guide your technical decisions.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className='space-y-6'>
                      ...
                      <div className='space-y-4'>
                        <div className='bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg p-4 border border-orange-400/30'>
                          <h4 className='font-semibold text-white mb-2'>🎯 Intent-Driven Code</h4>
                          <p className='text-white/80 text-sm'>
                            Write code that expresses intent clearly, making it self-documenting and
                            maintainable.
                          </p>
                        </div>
                        <div className='bg-gradient-to-br from-yellow-500/20 to-amber-500/20 rounded-lg p-4 border border-yellow-400/30'>
                          ...
                          <p className='text-white/80 text-sm'>
                            Build with instant feedback loops, rapid iteration, and continuous
                            improvement cycles.
                          </p>
                        </div>
                        <div className='bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-lg p-4 border border-indigo-400/30'>
                          <h4 className='font-semibold text-white mb-2'>🌐 Web3-First Thinking</h4>
                          <p className='text-white/80 text-sm'>
                            Design for decentralization from the ground up, embracing trustless and
                  ...
                  <div className='bg-gradient-to-br from-white/5 to-white/10 rounded-xl p-6 border border-white/20'>
                    <h3 className='text-2xl font-bold text-white mb-6'>🎼 Vibecoding Workflow</h3>
                    <div className='grid md:grid-cols-4 gap-4'>
                      <div className='text-center p-4 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg border border-purple-400/30'>
                        ...
                        <p className='text-white/80 text-sm'>
                          Create your perfect coding environment - music, lighting, and tools that
                          inspire creativity.
                        </p>
                      </div>
                      <div className='text-center p-4 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-lg border border-cyan-400/30'>
                        ...
                        <p className='text-white/80 text-sm'>
                          Visualize your solution before coding. Map out the problem space and
                      ...
                      <div className='text-center p-4 bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-lg border border-green-400/30'>
                        ...
                        <p className='text-white/80 text-sm'>
                          Build quickly, test often, iterate fast. Embrace the "build, break,
                          rebuild" cycle.
                        </p>
                      </div>
                      <div className='text-center p-4 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg border border-orange-400/30'>
                        ...
                        <p className='text-white/80 text-sm'>
                          Refine your creation, add the finishing touches, and ship with confidence.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className='grid md:grid-cols-3 gap-6'>
                      <div>
                        ...
                        <ul className='text-white/80 text-sm space-y-2'>
                          <li>
                            • <strong>VS Code:</strong> With vibecoding extensions
                          </li>
                          <li>
                            • <strong>Neovim:</strong> For the terminal flow state
                          </li>
                          <li>
                            • <strong>WebStorm:</strong> Full-featured IDE experience
                          </li>
                          <li>
                            • <strong>Cursor:</strong> AI-powered coding assistant
                          </li>
                        </ul>
                      </div>
                      <div>
                        ...
                        <ul className='text-white/80 text-sm space-y-2'>
                          <li>
                            • <strong>React:</strong> Component-based vibes
                          </li>
                          <li>
                            • <strong>Next.js:</strong> Full-stack flow
                          </li>
                          <li>
                            • <strong>TypeScript:</strong> Type-safe creativity
                          </li>
                          <li>
                            • <strong>Tailwind:</strong> Utility-first styling
                          </li>
                        </ul>
                      </div>
                      <div>
                        <h4 className='font-semibold text-accent-300 mb-3'>Web3 & Blockchain</h4>
                        <ul className='text-white/80 text-sm space-y-2'>
                          <li>
                            • <strong>Stellar SDK:</strong> Blockchain vibes
                          </li>
                          <li>
                            • <strong>Web3.js:</strong> Ethereum integration
                          </li>
                          <li>
                            • <strong>Wallet Connect:</strong> Seamless connections
                          </li>
                          <li>
                  ...
                  <div className='bg-gradient-to-br from-success-500/20 to-success-400/20 rounded-xl p-6 border border-success-400/30'>
                    <h3 className='text-2xl font-bold text-white mb-4'>💻 Vibecoding in Action</h3>
...
export default VibecodingComponent;`}
                  ...
                  <div className='bg-gradient-to-br from-warning-500/20 to-warning-400/20 rounded-xl p-6 border border-warning-400/30'>
                    <h3 className='text-2xl font-bold text-white mb-4'>📚 Vibecoding Resources</h3>
                    <div className='grid md:grid-cols-2 gap-6'>
                      <div>
                        <h4 className='font-semibold text-warning-300 mb-3'>Learning Resources</h4>
                        <ul className='text-white/80 text-sm space-y-2'>
                          <li>
                            • <strong>Vibecoding Academy:</strong> Master the art of flow coding
                          </li>
                          <li>
                            • <strong>Flow State Podcast:</strong> Interviews with vibecoding
                            masters
                          </li>
                          <li>
                            • <strong>Coding Playlists:</strong> Curated music for different coding
                            moods
                          </li>
                          <li>
                            • <strong>Vibe Templates:</strong> Pre-configured development
                            environments
                          </li>
                        </ul>
                      </div>
                      <div>
                        <h4 className='font-semibold text-warning-300 mb-3'>Community & Tools</h4>
                        <ul className='text-white/80 text-sm space-y-2'>
                          <li>
                            • <strong>Vibecoding Discord:</strong> Connect with fellow vibe coders
                          </li>
                          <li>
                            • <strong>Flow Metrics:</strong> Track your coding flow states
                          </li>
                          <li>
                            • <strong>Vibe Checker:</strong> Analyze your code's vibes
                          </li>
                          <li>
                            • <strong>Collaborative Sessions:</strong> Pair programming with vibes
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              {activeTab === 'founder' && (
                <>
                  ...
                  {activeSection === 'trustless-work' && (
                    <div className='space-y-8'>
                      <div className='text-center mb-8'>
                        ...
                        <p className='text-lg text-white/80 max-w-3xl mx-auto'>
                          Everything founders need to know about Trustless Work mechanics, escrow
                          systems, and building decentralized work platforms on Stellar.
                        </p>
                      </div>
                        ...
                        <div className='space-y-6'>
                          ...
                          <div className='space-y-4'>
                            <div className='bg-gradient-to-br from-brand-500/20 to-brand-400/20 rounded-lg p-4 border border-brand-400/30'>
                              ...
                              <p className='text-white/80 text-sm'>
                                Automated fund management with programmable logic. No
                                intermediaries, no trust required - just code and blockchain
                                security.
                              </p>
                            </div>
                            <div className='bg-gradient-to-br from-success-500/20 to-success-400/20 rounded-lg p-4 border border-success-400/30'>
                              <h4 className='font-semibold text-white mb-2'>⚡ Instant Payments</h4>
                              <p className='text-white/80 text-sm'>
                                Built on Stellar's fast, low-cost network. Payments settle in 3-5
                            ...
                            <div className='bg-gradient-to-br from-accent-500/20 to-accent-400/20 rounded-lg p-4 border border-accent-400/30'>
                              ...
                              <p className='text-white/80 text-sm'>
                                Borderless transactions, no geographic restrictions, and 24/7
                                availability for global teams.
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className='space-y-6'>
                          ...
                          <div className='space-y-4'>
                            ...
                            <div className='bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-lg p-4 border border-cyan-400/30'>
                              ...
                              <p className='text-white/80 text-sm'>
                                Instant settlements, automated milestone tracking, and reduced
                            ...
                            <div className='bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-lg p-4 border border-green-400/30'>
                              ...
                              <p className='text-white/80 text-sm'>
                                Built-in dispute resolution, time-locked releases, and
                                multi-signature security for complex projects.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className='bg-gradient-to-br from-white/5 to-white/10 rounded-xl p-6 border border-white/20'>
                        <h3 className='text-2xl font-bold text-white mb-6'>🛠️ Getting Started</h3>
                        <div className='grid md:grid-cols-4 gap-4'>
                          <div className='text-center p-4 bg-gradient-to-br from-brand-500/20 to-brand-400/20 rounded-lg border border-brand-400/30'>
                            ...
                            <p className='text-white/80 text-sm'>
                              Learn how smart contract escrow works and its benefits for your
                              business.
                            </p>
                          </div>
                          <div className='text-center p-4 bg-gradient-to-br from-success-500/20 to-success-400/20 rounded-lg border border-success-400/30'>
                            ...
                            <p className='text-white/80 text-sm'>
                              Identify projects, services, or work that can benefit from escrow
                              mechanics.
                            </p>
                          </div>
                          <div className='text-center p-4 bg-gradient-to-br from-accent-500/20 to-accent-400/20 rounded-lg border border-accent-400/30'>
                            ...
                            <p className='text-white/80 text-sm'>
                              Design workflows, define milestones, and plan dispute resolution
                              processes.
                            </p>
                          </div>
                          <div className='text-center p-4 bg-gradient-to-br from-warning-500/20 to-warning-400/20 rounded-lg border border-warning-400/30'>
                            ...
                            <p className='text-white/80 text-sm'>
                              Deploy your solution, onboard users, and scale your trustless work
                              platform.
                            </p>
                          </div>
                        </div>
                  ...
                  {activeSection === 'stellar-guide' && (
                    <div className='space-y-8'>
                      <div className='text-center mb-8'>
                        <h2 className='text-3xl font-bold text-white mb-4'>⭐ Stellar Guide</h2>
                        <p className='text-lg text-white/80 max-w-3xl mx-auto'>
                      ...
                      <div className='grid md:grid-cols-2 gap-8'>
                        {/* Stellar Advantages */}
                        <div className='space-y-6'>
                          <h3 className='text-2xl font-bold text-brand-300'>🌟 Why Stellar?</h3>
                          <div className='space-y-4'>
                            <div className='bg-gradient-to-br from-brand-500/20 to-brand-400/20 rounded-lg p-4 border border-brand-400/30'>
                              <h4 className='font-semibold text-white mb-2'>⚡ Fast & Cheap</h4>
                              <p className='text-white/80 text-sm'>
                                3-5 second finality with ultra-low fees (~$0.000001 per
                                transaction). Perfect for high-volume applications.
                              </p>
                            </div>
                            <div className='bg-gradient-to-br from-success-500/20 to-success-400/20 rounded-lg p-4 border border-success-400/30'>
                              <h4 className='font-semibold text-white mb-2'>🌍 Global Reach</h4>
                              <p className='text-white/80 text-sm'>
                                Built for cross-border payments with native multi-asset support and
                            ...
                            <div className='bg-gradient-to-br from-accent-500/20 to-accent-400/20 rounded-lg p-4 border border-accent-400/30'>
                              ...
                              <p className='text-white/80 text-sm'>
                                Seamless integration with traditional financial systems and other
                                blockchain networks.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className='space-y-6'>
                          ...
                          <div className='space-y-4'>
                            <div className='bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg p-4 border border-purple-400/30'>
                              ...
                              <p className='text-white/80 text-sm'>
                                Process payments, subscriptions, and recurring transactions with
                                minimal fees and instant settlement.
                              </p>
                            </div>
                            <div className='bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-lg p-4 border border-cyan-400/30'>
                              <h4 className='font-semibold text-white mb-2'>🏦 Banking Services</h4>
                              <p className='text-white/80 text-sm'>
                                Build banking solutions, remittances, and financial services with
                                regulatory compliance.
                              </p>
                            </div>
                            <div className='bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-lg p-4 border border-green-400/30'>
                              <h4 className='font-semibold text-white mb-2'>🔐 Escrow Services</h4>
                              <p className='text-white/80 text-sm'>
                                Implement smart contract escrow for freelancing, e-commerce, and
                      ...
                      {/* Stellar Ecosystem */}
                      <div className='bg-gradient-to-br from-warning-500/20 to-warning-400/20 rounded-xl p-6 border border-warning-400/30'>
                        <h3 className='text-2xl font-bold text-white mb-4'>🌐 Stellar Ecosystem</h3>
                        <div className='grid md:grid-cols-3 gap-6'>
                          <div>
                            <h4 className='font-semibold text-warning-300 mb-3'>Core Assets</h4>
                            <ul className='text-white/80 text-sm space-y-2'>
                              <li>
                                • <strong>XLM:</strong> Native currency for fees and operations
                              </li>
                              <li>
                                • <strong>USDC:</strong> USD-pegged stablecoin for stable value
                              </li>
                              <li>
                                • <strong>Custom Assets:</strong> Create your own tokens
                              </li>
                              <li>
                                • <strong>Anchors:</strong> Fiat currency gateways
                              </li>
                            </ul>
                          </div>
                          <div>
                            ...
                            <ul className='text-white/80 text-sm space-y-2'>
                              <li>
                                • <strong>Stellar SDK:</strong> Core development library
                              </li>
                              <li>
                                • <strong>Horizon API:</strong> Blockchain data access
                              </li>
                              <li>
                                • <strong>Laboratory:</strong> Testing and experimentation
                              </li>
                              <li>
                                • <strong>Network Explorer:</strong> Transaction monitoring
                              </li>
                            </ul>
                          </div>
                          <div>
                            ...
                            <ul className='text-white/80 text-sm space-y-2'>
                              <li>
                                • <strong>Circle:</strong> USDC issuer and payments
                              </li>
                              <li>
                                • <strong>MoneyGram:</strong> Global remittances
                              </li>
                              <li>
                                • <strong>IBM:</strong> Enterprise blockchain solutions
                              </li>
                              <li>
                                • <strong>Banking Partners:</strong> Traditional finance integration
                              </li>
                            </ul>
                          </div>
                        </div>
                ...
                <div className='space-y-8'>
                  <div className='text-center mb-8'>
                    ...
                    <p className='text-lg text-white/80'>
                      Comprehensive overview of the Trustless Work system architecture and component
                      relationships
                    </p>
                  </div>
                    ...
                    <div className='grid md:grid-cols-2 gap-6'>
                      <div>
                        ...
                        <ul className='text-white/80 text-sm space-y-2'>
                          ...
                          <li>
                            • <strong>Logic Layer:</strong> Trustless Work SDK with business logic
                          </li>
                          <li>
                      ...
                      <div>
                        ...
                        <ul className='text-white/80 text-sm space-y-2'>
                          ...
                          <li>
                            • <strong>State → Logic:</strong> Context uses SDK hooks for business
                            operations
                          </li>
                          <li>
                            • <strong>Logic → Blockchain:</strong> SDK executes Stellar operations
                            and contract logic
                          </li>
                          <li>
                            • <strong>Blockchain → State:</strong> Network events update application
                            state
                          </li>
                        </ul>
                      </div>
                  ...
                  <div className='grid md:grid-cols-3 gap-6'>
                    ...
                    <div className='bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-400/30 rounded-2xl p-6 hover:border-purple-400/50 transition-all duration-300 group relative'>
                      ...
                      <div className='text-center mb-4'>
                        ...
                        <p className='text-white/70 text-sm mb-4'>
                          Build play-to-earn games with secure escrow for tournaments, rewards, and
                          trading.
                        </p>
                      </div>
